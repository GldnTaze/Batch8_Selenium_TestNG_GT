...
public class _7_BasicLocatorReview {
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println(signinLink.getText());
         WebElement previousAndExt=driver.findElement(By.name("frm"));
        System.out.println(previousAndExt.getText());

        WebElement samsungGlaxy=driver.findElement(By.tagName("h4"));
        System.out.println(samsungGlaxy.getText());
        ...
        System.out.println(nexus.getText());
        Thread.sleep(2000);
        driver.close();
