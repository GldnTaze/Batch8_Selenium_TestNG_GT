...
public class _1_HTML_Popups {
   ...
   driver.get("http://primefaces.org/showcase/ui/overlay/confirmDialog.xhtml?jfwid=73437");
        ...
        WebElement yesBtn = driver.findElement(By.xpath("(//span[text()='Yes'])[2]"));
        yesBtn.click();
        Thread.sleep(4000);

        WebElement confirmMsj = driver.findElement(By.xpath("(//span[text()='Confirm'])[2]"));

        Assert.assertTrue(confirmMsj.isDisplayed());
