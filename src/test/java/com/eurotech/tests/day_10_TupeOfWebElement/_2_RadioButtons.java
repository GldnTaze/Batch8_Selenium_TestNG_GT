...
WebDriver driver;
    ...
    @Test
    public void radioButtonsTesdt() throws InterruptedException {
        /**
    ...
    @Test
    public void radioButtonTest_Task() throws InterruptedException {
        /**
        ...
        WebElement input=driver.findElement(By.xpath("//div[@class=\"custom-control custom-radio custom-control-inline\"][2]//input"));
